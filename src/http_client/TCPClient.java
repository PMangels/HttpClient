...
public class TCPClient
{
    public static void main(String [] args) throws UnsupportedHTTPCommandException, URISyntaxException, IOException, UnsupportedHTTPVersionException {
        ...
        for (Element element: elements){
            getEmbeddedElement(connection, connections, absolutePath, element);
        }
    ...
    public static void getEmbeddedElement(Connection connection, ArrayList<Connection> connections, String absolutePath, Element element) throws URISyntaxException, IOException, UnsupportedHTTPVersionException {
        Response response;
